...
<body style="font-family: Arial, sans-serif; background:#f3f3f3; padding:20px;">
  <div style="max-width:600px; margin:auto; background:white; padding:20px; border-radius:8px;">
    ...
    <a href="${process.env.FRONTEND_URL}/reset-password/${data.token}" 
       style="display:inline-block; padding:12px 20px; background:#5a2d82; color:white; text-decoration:none; border-radius:5px;">
       Reset Password
    </a>

    <p style="margin-top:20px;">If you did not request this, please ignore this email.</p>

    <p style="color:#999; font-size:14px;">This link will expire in 5 minutes.</p>
